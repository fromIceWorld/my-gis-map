import * as echarts from "./ecahrts.min4.9";
  ...
  (L.OverlayEcharts = (L.version < "1.0" ? L.Class : L.Layer).extend({
    ...
    _redraw: function () {
      return (
        ...
        this.initECharts(),
        this.setOption(this._echart.getOption() || this._echartsOption),
        this
      );
    },
    clear: function () {
    ...
    _initECharts: function () {
      if (
        ...
        EchartsService.echartsIns = this._echart;
        this._echart.on("click", (params) => {
          EchartsService.eventBus.next(params);
        });
      }
